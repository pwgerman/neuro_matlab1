function animalinfo = animaldef(animalname, varargin)
% animaldef functionreturns the file information for an animal
% animalinfo = animaldef('AnimalName')  returns a cell array
% animalinfo = animaldef('AnimalName', 'outputstruct', 1) returns a struct
...
switch lower(animalname)
    ...
    case 'bukowski'
        animalinfo = {'bukowski', '/mnt/backup/walter/walter/phys/Buk/', 'Buk'};
    case 'cummings'
        animalinfo = {'Cummings', '/mnt/backup/walter/walter/phys/Cum/', 'Cum'};
    case 'dickinson'
        animalinfo = {'Dickinson', '/mnt/backup/walter/walter/phys/Dic/', 'Dic'};
    case 'eliot'
        animalinfo = {'Eliot', '/mnt/backup/walter/walter/phys/Eli/', 'Eli'};
    case 'jigsaw'
        animalinfo = {'Jigsaw', '/mnt/backup/walter/walter/phys/Jig/', 'Jig'};
    case 'p01'
...
if outputstruct
    [animalstruct.name animalstruct.dir animalstruct.pre] = deal(animalinfo{1}, animalinfo{2}, animalinfo{3});
    animalinfo = animalstruct;
end