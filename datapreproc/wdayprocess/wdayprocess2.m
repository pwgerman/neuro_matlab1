function toppeak = wdayprocess2(daydirect, animdirect, fileprefix, daynum, varargin)

% wdayprocess is a modification of dayprocess that can optionally take an
% array of inputs for CMPERPX that is equal in length to the number of
% epochs.  Each entry in CMPERPX is used for the corresponding epoch.
% Walter German 2011-11-9
%
