...
% 
% modified from "modifyTimes/correctTimes" to create a times.mat file de
% novo outside of matclust.
%
% This code saves a new times.mat file to the current working directory
% which should be the day directory for the animal
%

daydir = pwd;
times_mat_filename = fullfile(daydir,'times.mat'); %'times.mat';
...
% 
% Empty vectors/strings for label, beginning, and ending leave current
% values.
