function includecells = calcincludecells(minV, minPeak, animals, epochfilter, lessthan, varargin)
% includecells = CALCINCLUDECELLS(minV, minPeak, animals, epochfilter, lessthan, varargin)
