function viewplotspectrogram3(f, varargin)
% viewplotspectrogram3 plots z-score spectro w/ title info
% about tetrode).  Plots only the reference tetrode in a epoch. 
%
